...
<form class="max-w-2xl mx-auto m-3">
  @csrf
    <div class="flex shadow-xs rounded-base -space-x-0.5">
        ...
        <input type="search" id="search-dropdown" id="input-group-1" class="px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm focus:ring-brand focus:border-brand block w-full placeholder:text-body" placeholder="Search..." required>
